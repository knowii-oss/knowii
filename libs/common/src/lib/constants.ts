...
// Community resource
export const MIN_LENGTH_COMMUNITY_RESOURCE_NAME = 3;
export const MAX_LENGTH_COMMUNITY_RESOURCE_NAME = 64;
...
export const COMMUNITY_API_PATH_PARAM_COMMUNITY = '{communityCuid}';
export const COMMUNITY_API_PATH = `${API_BASE_PATH}/communities/${COMMUNITY_API_PATH_PARAM_COMMUNITY}`;

export const COMMUNITY_RESOURCE_COLLECTION_API_BASE_PATH_PARAM_COMMUNITY = COMMUNITY_API_PATH_PARAM_COMMUNITY;
...
export const COMMUNITY_RESOURCE_COLLECTION_API_PATH_PARAM_COMMUNITY = COMMUNITY_API_PATH_PARAM_COMMUNITY;
export const COMMUNITY_RESOURCE_COLLECTION_API_PATH_PARAM_RESOURCE_COLLECTION = '{resourceCollectionCuid}';
export const COMMUNITY_RESOURCE_COLLECTION_API_PATH = `${COMMUNITY_RESOURCE_COLLECTION_API_BASE_PATH}/${COMMUNITY_RESOURCE_COLLECTION_API_PATH_PARAM_RESOURCE_COLLECTION}`;

export const COMMUNITY_RESOURCE_TEXT_ARTICLES_API_BASE_PATH_PARAM_COMMUNITY = COMMUNITY_API_PATH_PARAM_COMMUNITY;
export const COMMUNITY_RESOURCE_TEXT_ARTICLES_API_BASE_PATH_PARAM_RESOURCE_COLLECTION =
  COMMUNITY_RESOURCE_COLLECTION_API_PATH_PARAM_RESOURCE_COLLECTION;
export const COMMUNITY_RESOURCE_TEXT_ARTICLES_API_BASE_PATH = `${COMMUNITY_RESOURCE_COLLECTION_API_PATH}/text-articles`;
