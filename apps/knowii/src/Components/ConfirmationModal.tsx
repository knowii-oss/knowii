...
ConfirmationModal.Content = function ConfirmationModalContent({ title, children }: PropsWithChildren<{ title: string }>) {
  return (
...
ConfirmationModal.Footer = function ConfirmationModalFooter({ children }: PropsWithChildren<Record<string, unknown>>) {
